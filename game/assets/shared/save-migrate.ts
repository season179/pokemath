...
import { mintCreatureId, legacyToPlayerProgress, LEGACY_XP_PER_LEVEL } from "./player-progression";
import type { OwnedCreatureState, SaveStateV2 } from "./save-v2";
import { markCaught, SAVE_VERSION, WORLD_LAYOUT_REVISION } from "./save-v2";
import { validateSaveV2 } from "./save-v2-validate";
import type { SaveState } from "./save-types";
import { validateSaveState } from "./save-validate";
