...
export const TRAIL_CLUES: readonly TrailClue[] = [
  {
    ...
    ...MEADOW_TICKTOCK_ANCHORS.trailClue,
  ...
  },
  {
    ...
    ...MEADOW_ORCHARD_ANCHORS.trailClue,
  ...
  },
  {
    ...
    ...MEADOW_GARDENS_ANCHORS.trailClue,
...
export const GUARDIAN_SPOT = MEADOW_STONES_ANCHORS.guardian;
